...
function Filter() {
  ...
  for (let i = 0; i < product.length; i++) {
    categoryArray.push(product[i].category);
  }
      ...
      >
        ...
        <div>
          <div className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-4 mt-4">
            ...
            className="px-4 py-3 w-full rounded-md bg-gray-50 border-transparent outline-0  focus:border-gray-500 focus:bg-white focus:ring-0 text-sm" placeholder="Min Price"/>
